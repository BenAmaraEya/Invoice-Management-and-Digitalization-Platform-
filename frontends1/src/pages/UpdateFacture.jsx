...
const UpdateFactureDetailsPage = () => {
  ...
  const changeDocuments = async (event) => {
    ...
    try {
      ...
      console.log('Erreur de téléchargement de facture ', error);
    }
  };
                ...
                <Col md="6">
                  ...
                  <FormGroup>
                    <label>
                      ...
                      <DatePicker selected={facture.date_fact} onChange={handleDateChange} />
                    </label>
                  </FormGroup>
                  <FormGroup>
                    <label>
                ...
                <Col md="6">
                  ...
                  <FormGroup>
                    <label>
                      ...
                      <DatePicker selected={facture.datereception} onChange={handleDateChange} />
                    </label>
                  </FormGroup>
                  <FormGroup>
                    <label>
                  ...
                  <FormGroup>
                    ...
                    <label>
                      ...
                      <button type="button" className="upload-btn" onClick={changeDocuments}>
                        Modifier Document
                      </button>
                    </label>
                  </FormGroup>
