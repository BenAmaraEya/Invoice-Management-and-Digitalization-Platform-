  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        <Text style={styles.title}>Vérifiez et complétez votre formulaire attentivement avant de soumettre.</Text>
        <View style={styles.factureContainer}>
          <View style={styles.factureForm}>
            ...
            <View style={styles.btnContainer}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('Factures',{ userId: id })}>
                <Text>Annuler</Text>
              </TouchableOpacity>
            </View>
          </View>
